...
For more information about access control policy parameters, see Active Directory Federation Serviceshttps://technet.microsoft.com/windows-server-docs/identity/active-directory-federation-services on TechNet.
