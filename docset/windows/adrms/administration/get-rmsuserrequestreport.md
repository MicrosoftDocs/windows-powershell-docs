...
```
C:\PS>Get-RmsUserRequestReport -Path "." -UserName "CONTOSO\PFuller"
```
...
```
C:\PS>Get-RmsUserRequestReport -Path "." -StartTime 2/1/2009 -EndTime 2/28/2009 -UserName "CONTOSO\PFuller" -RequestType "AcquireLicense"
```
...
```
C:\PS>Get-RmsUserRequestReport -Path "." -RequestType "AcquireLicense" -UserName "CONTOSO\PFuller" | Get-RmsRequestInfo -Path "."
```
