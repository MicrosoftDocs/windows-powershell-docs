...
Upgrades an AD RMS server and cluster that is using a cluster key password.
...
Updates an AD RMS server that is using a cluster key password to cryptographic mode 2.
