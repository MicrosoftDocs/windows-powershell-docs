...
Enter a computer name or a session object, such as the output of a [New-CimSession]https://docs.microsoft.com/powershell/module/cimcmdlets/new-cimsession?view=powershell-6) or [Get-CimSession](https://go.microsoft.com/fwlink/p/?LinkId=227966) cmdlet.
