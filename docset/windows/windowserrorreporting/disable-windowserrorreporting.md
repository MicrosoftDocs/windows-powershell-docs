...
After you run this cmdlet, WER again sends information about application failures to Microsoft. To cusomize the settings of Windows Error Reporting, use registry keys described in [WER Settings](https://docs.microsoft.com/windows/desktop/wer/wer-settings) article.
