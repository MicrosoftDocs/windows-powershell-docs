...
online version: https://learn.microsoft.com/powershell/module/activedirectory/get-adcentralaccessrule?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
### -------------------------- EXAMPLE 2 --------------------------
```
C:\PS>Get-ADCentralAccessRule -Filter "ResourceCondition -like '*Department*'"
```
