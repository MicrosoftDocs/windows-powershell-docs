...
online version: https://learn.microsoft.com/powershell/module/activedirectory/get-adrootdse?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
## DESCRIPTION
The Get-ADRootDSE cmdlet gets the conceptual object representing the root of the directory information tree of a directory server.
...
### -------------------------- EXAMPLE 3 --------------------------
```
C:\PS>Get-ADRootDSE -Server "FABRIKAM-ADLDS1.Fabrikam.com:60000" -Credential "FABRIKAM\User1"
