...
The Identity parameter specifies the Active Directory MSA to get.
...
To search for and retrieve more than one MSA, use the Filter or LDAPFilter parameters.
...
This cmdlet gets a default set of MSA object properties.
...
### -Identity
Distinguished Name Specifies an Active Directory account object by providing one of the following property values.
...
To run these examples, replace \<service account\> with a MSA identifier such as the name of a MSA.
