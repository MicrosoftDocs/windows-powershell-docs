...
online version: https://learn.microsoft.com/powershell/module/activedirectory/remove-adclaimtype?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
Example: CN=Employee Type,CN=Claim Types,CN=Claims Configuration,CN=Services,CN=Configuration,DC=corp,DC=contoso,DC=com
