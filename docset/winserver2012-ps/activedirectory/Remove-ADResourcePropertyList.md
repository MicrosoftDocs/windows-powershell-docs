...
online version: https://learn.microsoft.com/powershell/module/activedirectory/remove-adresourcepropertylist?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
### -------------------------- EXAMPLE 1 --------------------------
```
C:\PS>Remove-ADResourcePropertyList "Corporate Resource Property List"
```
...
### -------------------------- EXAMPLE 2 --------------------------
```
C:\PS>Get-ADResourcePropertyList -Filter 'Name -Like "Branch*"' | Remove-ADResourcePropertyList
```
