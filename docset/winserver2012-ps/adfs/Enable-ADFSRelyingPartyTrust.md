...
Module Name: ADFS
online version: https://learn.microsoft.com/powershell/module/adfs/enable-adfsrelyingpartytrust?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
### -------------------------- EXAMPLE 1 --------------------------
```
C:\PS>Enable-ADFSRelyingPartyTrust -TargetName "My application"
```
...
### -TargetRelyingParty
Specifies the relying party trust to enable.
