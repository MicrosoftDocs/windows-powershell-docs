...
online version: https://learn.microsoft.com/powershell/module/branchcache/enable-bchostedclient?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
However, nextref_server_7-based hosted cache servers must have a certificate enrolled, and can only be contacted when client computers use the HTTPS protocol on the TCP port `443`.
