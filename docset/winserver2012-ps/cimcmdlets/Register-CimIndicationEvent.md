...
This set of commands subscribes to the events generated by the class named Win32_ProcessStartTrace which raises an event whenever a process starts, and gets the events with ProcessStarted subscription using the Get-Eventhttp://go.microsoft.com/fwlink/p/?LinkId=113453 cmdlet.
...
Events received from the CIM server are stored in the event queue in the current Windows PowerShell session and then runs a local Get-Eventhttp://technet.microsoft.com/library/hh849909.aspx to retrieve the events.
...
[Get-Event](http://go.microsoft.com/fwlink/p/?LinkId=113453)

[Remove-Event](http://go.microsoft.com/fwlink/p/?LinkId=135247)

[Unregister-Event](http://go.microsoft.com/fwlink/p/?LinkId=135269)

[Write-Host](http://go.microsoft.com/fwlink/p/?LinkId=113426)
