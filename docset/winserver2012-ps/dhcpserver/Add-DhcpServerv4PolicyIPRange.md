...
online version: https://learn.microsoft.com/powershell/module/dhcpserver/add-dhcpserverv4policyiprange?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Add-DhcpServerv4PolicyIPRange [-Name] <String> [-ScopeId] <IPAddress> [-StartRange] <IPAddress>
