...
online version: https://learn.microsoft.com/powershell/module/dhcpserver/get-dhcpserverv4scope?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-DhcpServerv4Scope [[-ScopeId] <IPAddress[]>] [-AsJob] [-CimSession <CimSession[]>] [-ComputerName <String>]
 [-ThrottleLimit <Int32>]
```
