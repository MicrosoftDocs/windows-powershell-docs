...
online version: https://learn.microsoft.com/powershell/module/dhcpserver/remove-dhcpserverv6class?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Remove-DhcpServerv6Class [-Name] <String[]> [-Type] <String> [-AsJob] [-CimSession <CimSession[]>]
