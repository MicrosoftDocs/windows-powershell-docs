...
online version: https://learn.microsoft.com/powershell/module/dhcpserver/set-dhcpserverv4optiondefinition?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-DhcpServerv4OptionDefinition [-OptionId] <UInt32> [-AsJob] [-CimSession <CimSession[]>]
