...
online version: https://learn.microsoft.com/powershell/module/dhcpserver/set-dhcpserverv6reservation?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-DhcpServerv6Reservation [-IPAddress] <IPAddress> [-AsJob] [-CimSession <CimSession[]>]
 [-ClientDuid <String>] [-ComputerName <String>] [-Description <String>] [-Iaid <UInt32>] [-Name <String>]
...
### -IPAddress
Specifies the IPv6 address of the reservation being modified.
