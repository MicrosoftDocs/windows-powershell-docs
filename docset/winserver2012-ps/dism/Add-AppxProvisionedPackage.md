...
online version: https://learn.microsoft.com/powershell/module/dism/add-appxprovisionedpackage?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
To install and run apps on Windows Server 2012, you must install the [Desktop Experience Overview](/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/dn609826(v=ws.11)).
