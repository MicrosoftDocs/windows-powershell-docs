...
online version: https://learn.microsoft.com/powershell/module/dism/add-windowspackage?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
If *PackagePath* is a folder that contains a .cab or .msu files at its root, any subfolders are also recursively checked for .cab and .msu files.
