...
online version: https://learn.microsoft.com/powershell/module/dism/get-appxprovisionedpackage?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
### Example 1: List the app packages the mounted image to install for each account
```
