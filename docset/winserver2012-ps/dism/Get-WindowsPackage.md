...
online version: https://learn.microsoft.com/powershell/module/dism/get-windowspackage?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
### Example 1: List packages in a mounted image
```
...
### Example 2: List details about a package in a mounted image
```
