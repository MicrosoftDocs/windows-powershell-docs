...
online version: https://learn.microsoft.com/powershell/module/dism/remove-appxprovisionedpackage?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
App packages are not installed when new user accounts are created.
Packages are not removed from existing user accounts.
