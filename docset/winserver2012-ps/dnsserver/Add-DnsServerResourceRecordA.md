...
online version: https://learn.microsoft.com/powershell/module/dnsserver/add-dnsserverresourcerecorda?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Add-DnsServerResourceRecordA [-ZoneName] <String> [-Name] <String> [-IPv4Address] <IPAddress[]> [-AgeRecord]
