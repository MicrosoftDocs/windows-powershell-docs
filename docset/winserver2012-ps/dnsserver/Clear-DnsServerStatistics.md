...
online version: https://learn.microsoft.com/powershell/module/dnsserver/clear-dnsserverstatistics?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Clear-DnsServerStatistics [-AsJob] [-CimSession <CimSession[]>] [-ComputerName <String>] [-Force]
