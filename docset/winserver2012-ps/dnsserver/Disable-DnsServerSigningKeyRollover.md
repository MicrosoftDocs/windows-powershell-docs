...
online version: https://learn.microsoft.com/powershell/module/dnsserver/disable-dnsserversigningkeyrollover?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Disable-DnsServerSigningKeyRollover [-ZoneName] <String> [-KeyId] <Guid> [-AsJob] [-CimSession <CimSession[]>]
