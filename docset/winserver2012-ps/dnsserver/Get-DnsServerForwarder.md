...
online version: https://learn.microsoft.com/powershell/module/dnsserver/get-dnsserverforwarder?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-DnsServerForwarder [-AsJob] [-CimSession <CimSession[]>] [-ComputerName <String>] [-ThrottleLimit <Int32>]
```
