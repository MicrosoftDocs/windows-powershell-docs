...
online version: https://learn.microsoft.com/powershell/module/dnsserver/remove-dnsserverzone?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Remove-DnsServerZone [-Name] <String> [-AsJob] [-CimSession <CimSession[]>] [-ComputerName <String>] [-Force]
