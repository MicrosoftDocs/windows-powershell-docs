...
online version: https://learn.microsoft.com/powershell/module/failoverclusters/move-clustervirtualmachinerole?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Move-ClusterVirtualMachineRole [[-Name] <String>] [[-Node] <String>] [-Cancel] [-Cluster <String>]
 [-IgnoreLocked] [-InputObject <PSObject>] [-MigrationType <NativeGroupHelp.VmMigrationType>] [-VMId <Guid>]
 [-Wait <Int32>]
```
