...
online version: https://learn.microsoft.com/powershell/module/fileserverresourcemanager/new-fsrmautoquota?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
New-FsrmAutoQuota [-Path] <String> [-AsJob] [-CimSession <CimSession[]>] [-Disabled] [-Template <String>]
