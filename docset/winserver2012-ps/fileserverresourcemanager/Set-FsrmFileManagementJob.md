...
online version: https://learn.microsoft.com/powershell/module/fileserverresourcemanager/set-fsrmfilemanagementjob?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-FsrmFileManagementJob [-Name] <String[]> [-Action <CimInstance>] [-AsJob] [-CimSession <CimSession[]>]
 [-Condition <CimInstance[]>] [-Continuous] [-ContinuousLog] [-ContinuousLogSize <UInt64>]
 [-Description <String>] [-Disabled] [-MailTo <String>] [-Namespace <String[]>] [-Notification <CimInstance[]>]
 [-Parameters <String[]>] [-PassThru] [-ReportFormat <FmjReportFormatsEnum[]>]
 [-ReportLog <FmjReportLogsEnum[]>] [-Schedule <CimInstance>] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Set-FsrmFileManagementJob [-Action <CimInstance>] [-AsJob] [-CimSession <CimSession[]>]
 [-Condition <CimInstance[]>] [-Continuous] [-ContinuousLog] [-ContinuousLogSize <UInt64>]
 [-Description <String>] [-Disabled] [-MailTo <String>] [-Namespace <String[]>] [-Notification <CimInstance[]>]
 [-Parameters <String[]>] [-PassThru] [-ReportFormat <FmjReportFormatsEnum[]>]
 [-ReportLog <FmjReportLogsEnum[]>] [-Schedule <CimInstance>] [-ThrottleLimit <Int32>]
