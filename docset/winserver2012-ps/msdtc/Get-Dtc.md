...
Module Name: MsDTC
online version: https://learn.microsoft.com/powershell/module/msdtc/get-dtc?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-Dtc [-CimSession <CimSession[]>] [-DtcName <String>] [-ThrottleLimit <Int32>]
```
