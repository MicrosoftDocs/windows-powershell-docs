...
online version: https://learn.microsoft.com/powershell/module/netadapter/set-netadapterrsc?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-NetAdapterRsc [-Name] <String[]> [-AsJob] [-CimSession <CimSession[]>] [-IncludeHidden]
 [-IPv4Enabled <Boolean>] [-IPv6Enabled <Boolean>] [-NoRestart] [-PassThru] [-ThrottleLimit <Int32>] [-Confirm]
 [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Set-NetAdapterRsc [-AsJob] [-CimSession <CimSession[]>] [-IPv4Enabled <Boolean>] [-IPv6Enabled <Boolean>]
 [-NoRestart] [-PassThru] [-ThrottleLimit <Int32>] -InputObject <CimInstance[]> [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_3
```
Set-NetAdapterRsc [-AsJob] [-CimSession <CimSession[]>] [-IncludeHidden] [-IPv4Enabled <Boolean>]
 [-IPv6Enabled <Boolean>] [-NoRestart] [-PassThru] [-ThrottleLimit <Int32>] -InterfaceDescription <String[]>
 [-Confirm] [-WhatIf]
```
