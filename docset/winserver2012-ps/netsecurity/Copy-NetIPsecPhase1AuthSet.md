...
online version: https://learn.microsoft.com/powershell/module/netsecurity/copy-netipsecphase1authset?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Copy-NetIPsecPhase1AuthSet [-All] [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
...
```
Copy-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-NewGPOSession <String>] [-NewName <String>] [-NewPolicyStore <String>] [-PassThru] [-PolicyStore <String>]
 [-ThrottleLimit <Int32>] [-TracePolicyStore] -AssociatedNetIPsecRule <CimInstance> [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_3
```
Copy-NetIPsecPhase1AuthSet [-Name] <String[]> [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-NewGPOSession <String>] [-NewName <String>] [-NewPolicyStore <String>] [-PassThru] [-PolicyStore <String>]
 [-ThrottleLimit <Int32>] [-TracePolicyStore] [-Confirm] [-WhatIf]
```
...
```
Copy-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-NewGPOSession <String>] [-NewName <String>]
...
```
Copy-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-Description <String[]>]
 [-DisplayGroup <String[]>] [-GPOSession <String>] [-Group <String[]>] [-NewGPOSession <String>]
 [-NewName <String>] [-NewPolicyStore <String>] [-PassThru] [-PolicyStore <String>]
...
```yaml
Type: String
Parameter Sets: UNNAMED_PARAMETER_SET_1, UNNAMED_PARAMETER_SET_2, UNNAMED_PARAMETER_SET_3, UNNAMED_PARAMETER_SET_4, UNNAMED_PARAMETER_SET_6, UNNAMED_PARAMETER_SET_7
Aliases: 
