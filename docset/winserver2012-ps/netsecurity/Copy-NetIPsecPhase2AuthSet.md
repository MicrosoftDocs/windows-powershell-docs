...
online version: https://learn.microsoft.com/powershell/module/netsecurity/copy-netipsecphase2authset?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Copy-NetIPsecPhase2AuthSet [-All] [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
...
```
Copy-NetIPsecPhase2AuthSet [-AsJob] [-CimSession <CimSession[]>] [-NewGPOSession <String>] [-NewName <String>]
...
```
Copy-NetIPsecPhase2AuthSet [-AsJob] [-CimSession <CimSession[]>] [-Description <String[]>]
...
```
Copy-NetIPsecPhase2AuthSet [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-NewGPOSession <String>] [-NewName <String>] [-NewPolicyStore <String>] [-PassThru] [-PolicyStore <String>]
...
```
Copy-NetIPsecPhase2AuthSet [-Name] <String[]> [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-NewGPOSession <String>] [-NewName <String>] [-NewPolicyStore <String>] [-PassThru] [-PolicyStore <String>]
 [-ThrottleLimit <Int32>] [-TracePolicyStore] [-Confirm] [-WhatIf]
```
...
Note: Only one phase 2 authentication set can be copied at a time when copying to the same policy store.
