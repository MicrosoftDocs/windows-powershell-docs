...
online version: https://docs.microsoft.com/powershell/module/netsecurity/get-netfirewallinterfacefilter?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-NetFirewallInterfaceFilter [-All] [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-PolicyStore <String>] [-ThrottleLimit <Int32>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-NetFirewallInterfaceFilter [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
...
This allows for rule querying based on the InterfaceAlias parameter; this cmdlet returns filter objects that may be further queried with the Where-Objecthttps://go.microsoft.com/fwlink/p/?LinkId=113423 cmdlet.
