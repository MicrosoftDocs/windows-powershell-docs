...
online version: https://learn.microsoft.com/powershell/module/netsecurity/get-netfirewallservicefilter?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-NetFirewallServiceFilter [-All] [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-PolicyStore <String>] [-ThrottleLimit <Int32>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-NetFirewallServiceFilter [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
...
```
Get-NetFirewallServiceFilter [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
 [-PolicyStore <String>] [-Service <String[]>] [-ThrottleLimit <Int32>]
```
