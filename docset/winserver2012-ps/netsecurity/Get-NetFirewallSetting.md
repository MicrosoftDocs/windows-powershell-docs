...
online version: https://learn.microsoft.com/powershell/module/netsecurity/get-netfirewallsetting?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-NetFirewallSetting [-All] [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
