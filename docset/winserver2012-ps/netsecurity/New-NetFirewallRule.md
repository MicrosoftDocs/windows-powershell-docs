...
online version: https://learn.microsoft.com/powershell/module/netsecurity/new-netfirewallrule?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
New-NetFirewallRule [-Action <Action>] [-AsJob] [-Authentication <Authentication>] [-CimSession <CimSession[]>]
 ...
 [-Group <String>] [-IcmpType <String[]>] [-InterfaceAlias <WildcardPattern[]>]
 [-InterfaceType <InterfaceType>] [-LocalAddress <String[]>] [-LocalOnlyMapping <Boolean>]
 [-LocalPort <String[]>] [-LocalUser <String>] [-LooseSourceMapping <Boolean>] [-Name <String>]
 ...
 [-Service <String>] [-ThrottleLimit <Int32>] -DisplayName <String> [-Confirm] [-WhatIf]
```
