...
online version: https://learn.microsoft.com/powershell/module/netsecurity/new-netipsecmainmodecryptoset?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
New-NetIPsecMainModeCryptoSet [-AsJob] [-CimSession <CimSession[]>] [-Default] [-Description <String>]
 [-ForceDiffieHellman <Boolean>] [-GPOSession <String>] [-Group <String>] [-MaxMinutes <UInt32>]
 [-MaxSessions <UInt32>] [-Name <String>] [-PolicyStore <String>] [-ThrottleLimit <Int32>]
...
Note: Use the Any keyword to configure the profile as Private, Public, Domain in this store. 
