...
online version: https://learn.microsoft.com/powershell/module/netsecurity/new-netipsecphase1authset?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
New-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-Default] [-Description <String>]
