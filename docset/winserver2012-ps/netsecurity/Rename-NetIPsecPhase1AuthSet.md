...
online version: https://learn.microsoft.com/powershell/module/netsecurity/rename-netipsecphase1authset?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Rename-NetIPsecPhase1AuthSet [-All] [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>] [-PassThru]
 [-PolicyStore <String>] [-ThrottleLimit <Int32>] [-TracePolicyStore] -NewName <String> [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Rename-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>] [-PassThru]
...
```
Rename-NetIPsecPhase1AuthSet [-Name] <String[]> [-AsJob] [-CimSession <CimSession[]>] [-GPOSession <String>]
...
```
Rename-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-PassThru] [-ThrottleLimit <Int32>]
...
```
Rename-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-Description <String[]>]
