...
online version: https://learn.microsoft.com/powershell/module/netsecurity/save-netgpo?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Save-NetGPO [-GPOSession] <String> [-AsJob] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>]
```
