...
online version: https://learn.microsoft.com/powershell/module/netsecurity/set-netipsecphase1authset?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-Description <String>] [-GPOSession <String>]
...
```
Set-NetIPsecPhase1AuthSet [-AsJob] [-CimSession <CimSession[]>] [-Description <String>]
...
```
Set-NetIPsecPhase1AuthSet [-Name] <String[]> [-AsJob] [-CimSession <CimSession[]>] [-Description <String>]
...
Note: This parameter cannot be specified upon object creation using the New-NetIPsecPhase1AuthSet cmdlet, but can be modified using dot notation and this cmdlet.
...
Note: The **DisplayGroup** parameter cannot be specified upon object creation using the New-NetIPsecPhase1AuthSet cmdlet, but can be modified using dot notation and this cmdlet.
