...
online version: https://learn.microsoft.com/powershell/module/networktransition/new-netnattransitionconfiguration?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
New-NetNatTransitionConfiguration [-AsJob] [-CimSession <CimSession[]>] [-InboundInterface <String[]>]
 [-IPv4AddressPortPool <String[]>] [-OutboundInterface <String[]>] [-PolicyStore <PolicyStore>]
 [-PrefixMapping <String[]>] [-State <State>] [-TcpMappingTimeoutSeconds <UInt32>] [-ThrottleLimit <Int32>]
 -InstanceName <String> [-Confirm] [-WhatIf]
```
