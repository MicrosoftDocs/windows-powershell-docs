...
online version: https://learn.microsoft.com/powershell/module/networktransition/remove-netnattransitionconfiguration?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Remove-NetNatTransitionConfiguration [-Adapter <CimInstance>] [-AsJob] [-CimSession <CimSession[]>]
...
```
Remove-NetNatTransitionConfiguration [-AsJob] [-CimSession <CimSession[]>] [-PassThru] [-ThrottleLimit <Int32>]
...
### -InputObject
Specifies the NAT64 configuration object to remove.
