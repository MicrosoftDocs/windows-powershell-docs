...
online version: https://learn.microsoft.com/powershell/module/remoteaccess/disconnect-vpns2sinterface?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Disconnect-VpnS2SInterface [-Name] <String> [-AsJob] [-CimSession <CimSession[]>] [-Force] [-PassThru]
