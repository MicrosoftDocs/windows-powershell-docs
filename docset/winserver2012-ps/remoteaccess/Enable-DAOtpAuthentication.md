...
online version: https://learn.microsoft.com/powershell/module/remoteaccess/enable-daotpauthentication?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Enable-DAOtpAuthentication [-AsJob] [-CAServer <String[]>] [-CertificateTemplateName <String>]
 [-CimSession <CimSession[]>] [-ComputerName <String>] [-Force] [-PassThru] [-RadiusPort <UInt16>]
 [-RadiusServer <String>] [-SharedSecret <String>] [-SigningCertificateTemplateName <String>]
 [-ThrottleLimit <Int32>] [-UserSecurityGroupName <String>] [-Confirm] [-WhatIf]
```
