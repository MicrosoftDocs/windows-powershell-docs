...
online version: https://learn.microsoft.com/powershell/module/remoteaccess/get-daclient?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-DAClient [[-EntrypointName] <String>] [-AsJob] [-CimSession <CimSession[]>] [-ComputerName <String>]
 [-ThrottleLimit <Int32>]
```
