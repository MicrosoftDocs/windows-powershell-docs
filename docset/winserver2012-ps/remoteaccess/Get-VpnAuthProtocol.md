...
online version: https://learn.microsoft.com/powershell/module/remoteaccess/get-vpnauthprotocol?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Get-VpnAuthProtocol [-AsJob] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>]
```
