...
online version: https://learn.microsoft.com/powershell/module/remoteaccess/set-daentrypoint?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-DAEntryPoint [-AsJob] [-CimSession <CimSession[]>] [-ComputerName <String>] [-GslbIP <IPAddress>]
 [-Name <String>] [-NewName <String>] [-PassThru] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf]
```
