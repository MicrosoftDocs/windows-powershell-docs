...
online version: https://learn.microsoft.com/powershell/module/remoteaccess/set-daotpauthentication?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Set-DAOtpAuthentication [-AsJob] [-CAServer <String[]>] [-CertificateTemplateName <String>]
 [-CimSession <CimSession[]>] [-ComputerName <String>] [-DisableTwoFactorBypass] [-PassThru]
 [-SigningCertificateTemplateName <String>] [-ThrottleLimit <Int32>] [-UserSecurityGroupName <String>]
 [-Confirm] [-WhatIf]
```
