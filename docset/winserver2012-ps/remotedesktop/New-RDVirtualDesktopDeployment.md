...
Module Name: RDMgmt
online version: https://learn.microsoft.com/powershell/module/rdmgmt/new-rdvirtualdesktopdeployment?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
New-RDVirtualDesktopDeployment [-ConnectionBroker] <String> [-WebAccessServer] <String>
 [-VirtualizationHost] <String[]> [-CreateVirtualSwitch] [<CommonParameters>]
```
