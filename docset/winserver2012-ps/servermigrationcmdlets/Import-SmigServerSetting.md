...
online version: https://learn.microsoft.com/powershell/module/servermigrationcmdlets/import-smigserversetting?view=windowsserver2012-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
---
...
```
Import-SmigServerSetting [[-Feature] <Feature[]>] [[-TargetPhysicalAddress] <String[]>] [[-IPConfig] <String>]
 [[-FeatureId] <String[]>] [[-User] <String>] [-Group] [[-SourcePhysicalAddress] <String[]>] [-Force]
 [-Path] <String> -Password <SecureString> [-Confirm] [-WhatIf]
```
