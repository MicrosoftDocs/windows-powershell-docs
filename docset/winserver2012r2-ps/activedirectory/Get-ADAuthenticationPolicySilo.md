...
ms.date: 10/30/2017
online version: https://docs.microsoft.com/powershell/module/activedirectory/get-adauthenticationpolicysilo?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
To get properties for an object and display them, you can use this cmdlet and pass the output to the Get-Memberhttps://go.microsoft.com/fwlink/?LinkID=293971 cmdlet by using the pipeline operator.
