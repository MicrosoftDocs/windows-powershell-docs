...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/activedirectory/get-adobject?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Get-ADObject
---
...
This example gets all the deleted objects whose **whenChanged** attribute is greater then the specified date and at the time of deletion were the children of the specified organizational unit.
