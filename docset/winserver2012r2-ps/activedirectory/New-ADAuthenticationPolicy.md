...
ms.date: 10/30/2017
online version: https://docs.microsoft.com/powershell/module/activedirectory/new-adauthenticationpolicy?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
New-ADAuthenticationPolicy [-WhatIf] [-Confirm] [-AuthType <ADAuthType>]
 ...
 [-OtherAttributes <Hashtable>] [-PassThru] [-ProtectedFromAccidentalDeletion <Boolean>] [-Server <String>]
...
You can use the pipeline operator and the Import-Csvhttps://go.microsoft.com/fwlink/?LinkID=293983 cmdlet to pass a list for bulk creation of objects in the directory. 
