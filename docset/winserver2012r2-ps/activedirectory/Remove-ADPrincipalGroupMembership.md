...
ms.date: 10/30/2017
online version: https://docs.microsoft.com/powershell/module/activedirectory/remove-adprincipalgroupmembership?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### -MemberOf
Specifies the Active Directory groups to remove a user, computer, or group from as a member.
