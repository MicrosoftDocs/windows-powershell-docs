...
ms.date: 10/29/2017
online version: https://learn.microsoft.com/powershell/module/branchcache/enable-bcdistributed?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
This example enables distributed cache mode on the computer.
