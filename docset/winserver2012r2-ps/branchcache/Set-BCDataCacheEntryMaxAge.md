...
ms.date: 10/29/2017
online version: https://learn.microsoft.com/powershell/module/branchcache/set-bcdatacacheentrymaxage?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### -TimeDays
Specifies the number of days, as an integer, that content information and content remain in the cache before being deleted.
