...
ms.assetid: 5EB7CD65-1B19-4230-A006-6E13B7805BE0
---
...
### -ClientOnly
Indicates that the instance is only created in Windows PowerShell® without going to the CIM server.
...
```yaml
Type: String[]
Parameter Sets: ClassNameComputerSet, ClassNameSessionSet, ResourceUriComputerSet, ResourceUriSessionSet
Aliases: 
