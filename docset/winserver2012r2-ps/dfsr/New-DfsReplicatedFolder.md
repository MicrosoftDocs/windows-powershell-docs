...
Module Name: DFSR
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/dfsr/new-dfsreplicatedfolder?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### -FileNameToExclude
Specifies an array of names and extensions of files that the DSFR service excludes and does not replicate in the replicated folder.
Provide only folder names for this parameter; do not specify full paths.
You can use wildcards.
