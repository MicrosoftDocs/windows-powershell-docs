...
Module Name: DFSR
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/dfsr/set-dfsreplicatedfolder?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
You can use this cmdlet to modify global settings of replicated folders such as filters and DFS Namespace associations.
