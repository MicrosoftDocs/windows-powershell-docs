...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/dhcpserver/remove-dhcpserverdnscredential?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
If you remove the credentials, the DHCP Server service uses the machine account of the system that runs the DHCP server to register or deregister client records with the DNS server.
