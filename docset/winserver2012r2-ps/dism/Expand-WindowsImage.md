...
ms.date: 10/29/2017
online version: https://learn.microsoft.com/powershell/module/dism/expand-windowsimage?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
Expand-WindowsImage -ImagePath <String> -Name <String> [-SplitImageFilePattern <String>] -ApplyPath <String>
 [-CheckIntegrity] [-ConfirmTrustedFile] [-NoRpFix] [-Verify] [-WIMBoot] [-LogPath <String>]
...
### -ConfirmTrustedFile
Validates the image for Trusted Desktop on a Windows® 8 or Windows® 8.1.
