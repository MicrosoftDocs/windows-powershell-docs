...
ms.date: 10/29/2017
online version: https://learn.microsoft.com/powershell/module/dism/save-windowsimage?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### -Append
Specifies the location of an existing .wim file to add the Windows image to when you save it.
