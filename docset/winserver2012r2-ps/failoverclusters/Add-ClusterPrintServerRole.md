...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/failoverclusters/add-clusterprintserverrole?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Add-ClusterPrintServerRole
---
...
```
Add-ClusterPrintServerRole [-Storage <StringCollection>] [-StaticAddress <StringCollection>]
