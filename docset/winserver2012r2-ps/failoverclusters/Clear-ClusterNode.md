...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/failoverclusters/clear-clusternode?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
```
Clear-ClusterNode [[-Name] <StringCollection>] [-Force] [-Wait <Int32>] [-InputObject <PSObject>]
