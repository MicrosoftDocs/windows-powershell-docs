...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/failoverclusters/start-clustergroup?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
```
Start-ClusterGroup [[-Name] <String>] [-IgnoreLocked] [-Wait <Int32>] [-InputObject <PSObject>]
