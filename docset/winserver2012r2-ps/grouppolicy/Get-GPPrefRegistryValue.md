...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/grouppolicy/get-gpprefregistryvalue?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### -------------------------- EXAMPLE 1 --------------------------
```
PS C:\> get-gpprefregistryvalue -name testgpo -context user -key hklm\software\microsoft\examplekey -valuename valueone 
...
### -------------------------- EXAMPLE 2 --------------------------
```
PS C:\> get-gpprefregistryvalue -name testgpo -context user -key hklm\software\microsoft\examplekey 
