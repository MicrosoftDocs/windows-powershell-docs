...
# GroupPolicy Module
## Description
This topic contains brief descriptions of the Windows PowerShell cmdlets used to administer Group Policy in Windows Server and Windows client with Remote Server Administration Tools (RSAT) installed. (RSAT includes the GPMC and the Group Policy cmdlets.)
