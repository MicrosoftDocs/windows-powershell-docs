...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/ipamserver/get-ipamblock?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Get-IpamBlock
---
...
Specify the **MappingToParentBlock** parameter to get all the child IP address ranges that belong to an address block.
