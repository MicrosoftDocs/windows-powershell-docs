...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/ipamserver/rename-ipamcustomfield?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
This command renames the user-defined custom field named Building.
