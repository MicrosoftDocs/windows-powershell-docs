...
Module Name: MSMQ
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/msmq/send-msmqqueue?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### -AcknowledgeType
Specifies the type of acknowledgment message that Message Queuing returns to one or more remote queues.
