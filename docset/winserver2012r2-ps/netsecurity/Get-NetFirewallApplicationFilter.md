...
ms.date: 10/30/2017
online version: https://docs.microsoft.com/powershell/module/netsecurity/get-netfirewallapplicationfilter?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
This allows for rule querying based on the application fields using the **Program** or **Package** parameters; this cmdlet returns filter objects that may be further queried with the Where-Objecthttps://go.microsoft.com/fwlink/p/?LinkId=113423 cmdlet.
