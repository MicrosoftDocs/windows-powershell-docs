...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/netsecurity/get-netipsecrule?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
This parameter is only supported on Windows Server 2008 R2 and later.
