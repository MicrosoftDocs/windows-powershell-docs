...
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/netsecurity/set-netipsecrule?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
On firstref_client_7, Windows Server 2008 R2, and Windows Server 2012, this value can also be Any.
...
On Windows® 7, Windows Server 2008 R2, and Windows Server 2012, this parameter value can also be Any.
When applied to a client computer, this option supports connection via a tunnel to a remote gateway or host regardless of the IP address or address type of the local computer.
