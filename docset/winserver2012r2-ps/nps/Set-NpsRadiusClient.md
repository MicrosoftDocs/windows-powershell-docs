...
Module Name: NPS
ms.date: 10/30/2017
online version: https://learn.microsoft.com/powershell/module/nps/set-npsradiusclient?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
Set-NpsRadiusClient [-Name] <String> [-Address <String>] [-AuthAttributeRequired <Boolean>]
 [-NapCompatible <Boolean>] [-SharedSecret <String>] [-VendorName <String>] [-Enabled <Boolean>]
 [<CommonParameters>]
```
