...
ms.date: 10/29/2017
online version: https://learn.microsoft.com/powershell/module/pcsvdevice/stop-pcsvdevice?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
```
Stop-PcsvDevice -InputObject <CimInstance[]> [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob]
