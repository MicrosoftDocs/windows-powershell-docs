...
ms.topic: reference
online version: https://docs.microsoft.com/powershell/module/rdmgmt/set-rdvirtualdesktopcollectionconfiguration?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
