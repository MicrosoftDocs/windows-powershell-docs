...
ms.date: 12/05/2017
online version: https://docs.microsoft.com/powershell/module/remoteaccess/disconnect-vpnuser?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
### EXAMPLE 1
```
@{navigationLink=@{uri=https://go.microsoft.com/fwlink/p/?LinkId=113302; linkText=Format-List}; #text=System.Management.Automation.PSObject[]}
```
