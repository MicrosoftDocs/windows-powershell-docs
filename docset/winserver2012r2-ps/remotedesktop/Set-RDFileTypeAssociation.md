...
Module Name: RDMgmt
ms.date: 10/29/2017
online version: https://learn.microsoft.com/powershell/module/rdmgmt/set-rdfiletypeassociation?view=windowsserver2012r2-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
Remote users connect to this server to obtain views of available Windows Server 2008 R2 RemoteApp programs, session-based desktops, and virtual desktops.
