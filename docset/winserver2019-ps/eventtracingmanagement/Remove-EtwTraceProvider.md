...
ms.technology: 
ms.topic: reference
online version: https://docs.microsoft.com/powershell/module/eventtracingmanagement/remove-etwtraceprovider?view=windowsserver2019-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
