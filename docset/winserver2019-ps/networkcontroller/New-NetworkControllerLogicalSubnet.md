...
ms.technology: 
ms.topic: reference
online version: https://docs.microsoft.com/powershell/module/networkcontroller/new-networkcontrollerlogicalsubnet?view=windowsserver2019-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
