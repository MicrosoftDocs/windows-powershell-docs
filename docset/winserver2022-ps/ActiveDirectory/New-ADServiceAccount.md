...
ms.date: 12/27/2016
online version: https://learn.microsoft.com/powershell/module/activedirectory/new-adserviceaccount?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
None will remove all encryption types from the account and may result in the KDC being unable to issue service tickets for services using the account.
