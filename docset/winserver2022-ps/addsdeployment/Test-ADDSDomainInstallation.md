...
authority (SOA) type DNS. For instance, if the value of `-NewDomainName` is corp.contoso.com, Active
Directory performs an SOA query for corp.contoso.com and ensures that the zone name in the response
is corp.contoso.com.
