...
Module Name: ADFS
ms.date: 12/20/2016
online version: https://docs.microsoft.com/powershell/module/adfs/set-adfswebapiapplication?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
Set-AdfsWebApiApplication [-TargetApplication] <WebApiApplication>
 ...
 [-RequestMFAFromClaimsProviders <Boolean>] [-DeviceAuthenticationMethod <DeviceAuthenticationMethod>]
