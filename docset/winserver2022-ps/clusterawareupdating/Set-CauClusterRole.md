...
[-SiteAwareUpdatingOrder <String[]>] [-OsRollingUpgrade] [[-ClusterName] <String>] [[-Credential]
...
### DefaultParamSet
```
Set-CauClusterRole [-AttemptSoftReboot] [[-ClusterName] <String>] [[-Credential] <PSCredential>]
