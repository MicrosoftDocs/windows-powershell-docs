...
ms.date: 12/20/2016
online version: https://docs.microsoft.com/powershell/module/failoverclusters/new-clustergroupset?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
## DESCRIPTION
Creates a set of groups. On this set you can control when other sets start and when this set starts
based on dependencies between sets.
