...
Module Name: Hyper-V
ms.date: 08/27/2021
online version: https://docs.microsoft.com/powershell/module/hyper-v/remove-vmpmemcontroller?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Remove-VMPmemController
---
...
### -Passthru
Specifies that an object is to be passed through to the pipeline representing the controller to be deleted.
