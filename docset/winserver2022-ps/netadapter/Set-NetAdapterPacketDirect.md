...
ms.date: 09/20/2021
online version: https://docs.microsoft.com/powershell/module/netadapter/set-netadapterpacketdirect?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Set-NetAdapterPacketDirect
---
...
### ByName (Default)
```
Set-NetAdapterPacketDirect [-Name] <String[]> [-IncludeHidden] [-Enabled <Boolean>] [-DomainId <UInt32>]
...
### ByInstanceID
```
Set-NetAdapterPacketDirect -InterfaceDescription <String[]> [-IncludeHidden] [-Enabled <Boolean>]
 [-DomainId <UInt32>] [-NoRestart] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### InputObject (cdxml)
```
Set-NetAdapterPacketDirect -InputObject <CimInstance[]> [-Enabled <Boolean>] [-DomainId <UInt32>] [-NoRestart]
