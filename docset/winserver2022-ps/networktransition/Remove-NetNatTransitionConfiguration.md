...
ms.technology: 
ms.topic: reference
online version: https://docs.microsoft.com/powershell/module/networktransition/remove-netnattransitionconfiguration?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
