...
**Note:** In Windows 11, this cmdlet exports the Start Menu layout in JSON (.json) file format. 

## EXAMPLES

### Example 1: Export the layout (Windows 10)
```
...
### Example 2: Export the layout (Windows 11)
```
