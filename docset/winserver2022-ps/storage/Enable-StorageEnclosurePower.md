...
Module Name: Storage
ms.date: 08/30/2021
online version: https://docs.microsoft.com/powershell/module/storage/enable-storageenclosurepower?view=windowsserver2022-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Enable-StorageEnclosurePower
---
...
```
Enable-StorageEnclosurePower [-FriendlyName] <String[]> [-SlotNumbers <UInt32[]>] [-CimSession <CimSession[]>]
 [-ThrottleLimit <Int32>] [-AsJob] [-PassThru] [<CommonParameters>]
```

### ByUniqueId
```
Enable-StorageEnclosurePower -UniqueId <String[]> [-SlotNumbers <UInt32[]>] [-CimSession <CimSession[]>]
 [-ThrottleLimit <Int32>] [-AsJob] [-PassThru] [<CommonParameters>]
```

### InputObject (cdxml)
```
Enable-StorageEnclosurePower -InputObject <CimInstance[]> [-SlotNumbers <UInt32[]>]
