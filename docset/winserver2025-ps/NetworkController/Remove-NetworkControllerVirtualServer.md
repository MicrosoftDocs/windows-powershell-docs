...
ms.date: 12/20/2016
online version: https://learn.microsoft.com/powershell/module/networkcontroller/remove-networkcontrollervirtualserver?view=windowsserver2025-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
...
```
Remove-NetworkControllerVirtualServer [-ResourceId] <String> [[-Etag] <String>] [-Force] -ConnectionUri <Uri>
