...
ms.date: 02/21/2024
online version: https://learn.microsoft.com/powershell/module/storagemigrationservice/remove-smscutoverpairing?view=windowsserver2025-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Remove-SmsCutoverPairing
---
...
```
Remove-SmsCutoverPairing -ComputerName <String> [-OrchestratorComputerName <String>]
