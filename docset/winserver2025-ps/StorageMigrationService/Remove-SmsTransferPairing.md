...
ms.date: 02/21/2024
online version: https://learn.microsoft.com/powershell/module/storagemigrationservice/remove-smstransferpairing?view=windowsserver2025-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Remove-SmsTransferPairing
---
...
```
Remove-SmsTransferPairing -ComputerName <String> [-OrchestratorComputerName <String>]
