...
# New-NetworkControllerLearnedIpAddress
...
```
New-NetworkControllerLearnedIpAddress [-ResourceId] <String> [[-Tags] <PSObject>]
 [-Properties] <LearnedIpAddressProperties> [[-Etag] <String>] [[-ResourceMetadata] <ResourceMetadata>]
...
```yaml
Type: Microsoft.Windows.NetworkController.LearnedIpAddressProperties
Parameter Sets: (All)
Aliases:
...
### Microsoft.Windows.NetworkController.LearnedIpAddressProperties
