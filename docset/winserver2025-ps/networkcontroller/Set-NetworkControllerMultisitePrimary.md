...
## DESCRIPTION
The Set-NetworkControllerMultisitePrimary cmdlet is used to change the primary site of a location in a Multisite configuration. 
This can be done in the off-chance that your original Primary site has gone offline and policies still need to be pushed and applied. 
Note, any policies that were being configured at the moment when the original primary site crashes will be lost and must be redone.

## EXAMPLES

### Example 1: Set new Primary site 
```powershell
PS C:\> $prop = new-object Microsoft.Windows.NetworkController.NetworkControllerMultisitePrimaryProperties
PS C:\> Set-NetworkControllerMultisitePrimary -ConnectionUri "https://site1.com" -Properties $prop -Force
```
