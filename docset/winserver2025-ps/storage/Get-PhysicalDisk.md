...
This example returns an array of all **PhysicalDisk** objects present in the computer, as shown in
...
Indicates that this cmdlet gets physical disks that are physically connected to the specified
storage node.
